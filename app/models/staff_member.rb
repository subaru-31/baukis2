class StaffMember < ApplicationRecord
  ...
  validates :family_name, :given_name, presence: true, format: { with: HUMAN_NAME_REGEXP }
  validates :given_name, :given_name, presence: true, format: { with: HUMAN_NAME_REGEXP }
